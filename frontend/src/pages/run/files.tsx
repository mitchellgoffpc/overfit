...
import { apiBase, formatRunTime, RULED_LINE } from "helpers";
      ...
      <div className="-mx-[1.5rem]">
        {isLoading && entries.length === 0 ? (
          ...
          entries.map((entry) => {
            ...
            const downloadUrl = `${apiBase}/accounts/${handle}/projects/${projectName}/runs/${runName}/files/download?path=${encodeURIComponent(filePath)}`;
            const inner = (
              <>
